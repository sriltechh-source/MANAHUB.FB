...
firebase.initializeApp({apiKey:"AIzaSyAp-g1syTD9Q8ZRgjdxQDbFF6D9l9zHISY",authDomain:"fir-v1-a695a.firebaseapp.com",projectId:"fir-v1-a695a",storageBucket:"fir-v1-a695a.firebasestorage.app",messagingSenderId:"50283321145",appId:"1:50283321145:web:94c4c204309c0914ff7ae8",measurementId:"G-XGEQ6DL16H"});
...
messaging.onBackgroundMessage(payload=>{
  ...
  return self.registration.showNotification(title,{body,icon:'/icons/icon-192.png',tag:'sricart-fcm',renotify:true,data:{url:payload.data?.url||'/'}});
});
